...
export default {
  ...
  methods: {
    init () {
      this.ruleForm.id = this.data._id
      this.ruleForm.icon = this.data.icon
      this.ruleForm.title = this.data.title
      this.dynamicTags = this.data.smallTitle
    },
    handleClose (tag) {
    ...
    submitForm (formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          }, {smallTitle: this.dynamicTags})
          Http.postQfModel('indexs/menu/update?id=' + this.ruleForm.id, param, function (data) {
